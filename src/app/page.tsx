      ...
      <section className="min-h-screen flex flex-col justify-end pt-[20vh] pb-[var(--space-xl)]">
        ...
        <Reveal delay={600}>
          ...
          <div className="flex items-center justify-between">
            ...
            >
              built by <span className="capitalize font-[400]">Venkataramana</span> <svg className="inline-block ml-0.5 w-[0.75em] h-[0.75em] align-middle" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 9L9 3M9 3H4M9 3v5" /></svg>
            </a>
            <span className="font-mono text-[var(--text-xs)] text-[#666]">
              OPEN SOURCE
            </span>
          </div>
        </Reveal>
